...
Future<LoginUser> loginUser(String email) async {
  try{
    final String apiUrl = 'https://5423-180-244-129-250.ngrok.io/user/login';
    ...
    if(HttpHeaders.authorizationHeader == null){
